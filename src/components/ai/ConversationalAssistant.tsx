      ...
      <CardFooter className="border-t p-3">
        <div className="w-full flex gap-2">
          <Textarea
            ...
            disabled={isProcessingMessage || (typeof isAIEnabled !== 'function' ? true : !isAIEnabled())}
            rows={2}
          />
          <Button 
            onClick={handleSendMessage}
            disabled={isProcessingMessage || !input.trim() || (typeof isAIEnabled !== 'function' ? true : !isAIEnabled())}
            className="self-end"
          >
            {isProcessingMessage ? (
